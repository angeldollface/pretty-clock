...
<!--Load all components and use them.-->
<template>
 <ClockCog/>
</template>
   
<!--
Register our "App", import our components, 
and register those with the "App".
-->
<script lang="ts">
import { defineComponent } from 'vue';
import ClockCog from './ClockCog.vue';
